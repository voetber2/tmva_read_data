...
int main(){                                                               
  ...
  //TFile *sig_2 = TFile::Open("$TMPDIR/H1.0j_GGFHT_B_6500_pt25.0_eta4.5_r100_101.root");
  TFile *bg = TFile::Open("$TMPDIR/born6.root");                          
  //TFile *bg_2 = TFile::Open("$TMPDIR/born5.root");                                
  //===============================================                       
  TFile* out = TFile::Open("data_17feat_pt200p.root", "RECREATE"); 
  //===============================================                         
  TChain* chain_b = (TChain*)bg->Get("t3"); 
  //chain_b->Add((TChain*)bg_2->Get("t3"));

  TChain* chain_s = (TChain*)sig->Get("t3");                              
  //chain_s->Add((TChain*)sig_2->Get("t3"));  
  //===============================================                            
